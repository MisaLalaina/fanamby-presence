...
const loadPresences = async () => {
  ...
  // Trouver la séance sélectionnée
  currentSession.value = sessions.value.find(s => s.idSeance == selectedSession.value) || {};
  
  // Charger les présences pour cette séance (simulé)
  // En réalité, vous feriez un appel API pour récupérer les présences existantes
  await fetchPlayers();
};
