  ...
  matches.value = [
    {
      ...
      adversaire: 'FC Olympique',
      dateMatch: '2023-10-15'
    },
    {
      idMatch: 2,
      competition: 'Coupe Nationale',
      adversaire: 'AS Victory',
      dateMatch: '2023-10-22'
    }
  ];
};
...
const fetchPlayers = async () => {
  ...
  players.value = [
    ...
    { idJoueur: 5, nom: 'Leroy', prenom: 'Thomas', poste: 'Attaquant' },
    { idJoueur: 6, nom: 'Moreau', prenom: 'Quentin', poste: 'Milieu' }
  ];
};
...
const fetchComposition = async (matchId) => {
  ...
  compositions.value = [
    ...
    },
    {
      ...
      isCapitaine: false,
      commentaire: 'Peut remplacer attaquant ou milieu',
      nom: 'Leroy',
      prenom: 'Thomas',
      poste: 'Attaquant'
    },
    {
      ...
      idMatch: 1,
      idJoueur: 6,
      idStatutComposition: 3,
      numeroMaillot: null,
      position: null,
      isCapitaine: false,
      commentaire: 'Blessure à la cheville',
      nom: 'Moreau',
      prenom: 'Quentin',
      poste: 'Milieu'
    }
...
const setAsCaptain = (player) => {
  // Retirer le statut de capitaine à tous les joueurs
